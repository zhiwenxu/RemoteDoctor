package com.uestcpg.remotedoctor.views.library;
...
import com.uestcpg.remotedoctor.views.library.LoopView.LoopView;
import com.uestcpg.remotedoctor.views.library.LoopView.OnItemSelectedListener;
...
public class AlertView implements OnItemSelectedListener {
    ...
    public void onItemSelected(LoopView view) {
        ...
        getDay(CalenderUtil.getYear(), Integer.parseInt(month));
    ...
    public AlertView(String title, Context context, OnConfirmeListener confirmeListener) {
        this.title = title;
        this.context = context;
...
//        dayView.setListener(this);
    ...
    private void initDateViews(LayoutInflater layoutInflater, List<String> year, final List<String> month, final List<String> day, String titlr) {
        ...
        hourView = (LoopView)viewGroup.findViewById(R.id.hour);
...
//        });
    ...
    protected void initListView() {
        ...
        if (cancel != null && style == Style.Alert) {
            ...
            tvAlert.setTextColor(context.getResources().getColor(R.color.scan_tv_red_color));

...
public class MeFragmentInformation extends Fragment implements View.OnClickListener{

    public static MeFragmentInformation getInstance(){
        return new MeFragmentInformation();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_me_information,null);
